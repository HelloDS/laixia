...
local function onPacketMatchDetails(packet)
    ...
    laixia.LocalPlayercfg.LaixiaMatchLimit = packet:getValue("JoinLimit")
    if laixia.LocalPlayercfg.LaixiaMatchLimit== 9999 then
        laixia.LocalPlayercfg.LaixiaMatchLimit =0
    end
    ...
    ObjectEventDispatch:pushEvent(_LAIXIA_EVENT_SHOW_MATCHLISTDETAIL_WINDOW, data)

end

return
    {
        ID = _LAIXIA_PACKET_SC_MatchDetailsID,
        name = "SCMatchDetails",
        data_array =
        {
