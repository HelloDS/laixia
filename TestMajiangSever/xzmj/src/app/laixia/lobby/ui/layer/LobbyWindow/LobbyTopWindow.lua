...
-----------------------------------------------------------------------------------------------------
        ...
        if laixia.kconfig.isYingKe == true then
            self:GetWidgetByName("Image_7"):setVisible(true)
            self:GetWidgetByName("Text_zhishibi"):setVisible(true)
            self:GetWidgetByName("Image_2_Copy_1"):setVisible(true)
            self:GetWidgetByName("Button_jiahao"):setVisible(true)
            ...
            self:GetWidgetByName("Image_3"):loadTexture("new_ui/common/new_common/jinbi.png")
        end
