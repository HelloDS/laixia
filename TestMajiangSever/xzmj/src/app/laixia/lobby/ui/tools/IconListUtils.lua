...
IconListUtils.m_itemSize = {width = 200, height = 200}
IconListUtils.m_iconSize = {width = 124, height = 124}
...
function IconListUtils.clickGameIcon(clickItem)
    ...
    if clickItem and clickItem.m_gameInfo then
        ...
        if gameId == "1" then
            local mainLayer = require("games.ddz.layer.MainLayer").new()
            app.m_mainLayer:addChild(mainLayer)
        end
    end
end
