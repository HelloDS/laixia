...
function TiShiYuweChat:onInit()
    ...
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_SHOW_TISHIYUWECHAT_WINDOW, handler(self, self.show))
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_HIDE_TISHIYUWECHAT_WINDOW, handler(self, self.destroy))
end
