...
function PokerDeskModel:GetSeverData(  )
        ...
        local tb = {
            ...
            ["server_ip"] =  "10.111.7.213",
                ...
                local da = { ["pokertype"] = "2",["zhuangval"] = 1,["zhuangid"] = 10001,["table_id"] = 1,["room_id"] = 1,
                 ["pokerinfo"] = {
                     [1] = {
                     ["seat"] = 1,
                     ["uid"] = 10001,
...
function PokerDeskModel:SetPlayerSP( id )
    ...
    for i = 1 ,4 do
        pid = playrTb[ i]
        self.mPlayPoptyTb[i]:initSP(self:GetPlayerDataInSever(  pid ))
    end
end
