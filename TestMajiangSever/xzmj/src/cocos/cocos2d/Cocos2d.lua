...
function cc.rectOutsideRect(rect1,rect2)
    

    if (rect2.x + rect2.width < rect1.x) or (rect2.y + rect2.height < rect1.y) then 
        return true
    end

    if (rect2.x > rect1.x + rect1.width) or (rect2.y > rect1.y + rect1.height) then 
        return true 
    end
...
function cc.rectContainRect(rect1,rect2)
    local ret = false

    if (rect2.x >= rect1.x) and (rect2.x + rect2.width  <= rect1.x + rect1.width) and
       (rect2.y >= rect1.y) and (rect2.y + rect2.height <= rect1.y + rect1.height) then
       ret = true
    end
