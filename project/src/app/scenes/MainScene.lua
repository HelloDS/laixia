...
xzmj.net.CloudSocket = import(xzmj.lx.."net.CloudSocket")
xzmj.net.LXEngine = import(xzmj.lx.."net.LXEngine")
...
xzmj.net.PokerHttp = import(xzmj.lx.."ui.layer.PokerDeskLayer.PokerHttp")
...
function MainScene.EnterXZGame( ... )
    ...
    xzmj.net.CloudSocket:socketInitandschedul()
end
