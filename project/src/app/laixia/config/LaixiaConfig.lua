...
local Laixia_Config = 
{
    ...
    --ServerURL = "http://192.168.2.199/laixia-hall/hall.do",  -- 内网
    ServerURL = "http://39.106.111.17:11121/laixia-hall/hall.do",-- 公网
    --ServerURL = "http://laixia.f3322.net:11121/laixia-hall/hall.do",--公测
