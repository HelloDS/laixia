...
laixia.soundcfg = import(".config.LaixiaSoundConfig")

laixia.LocalPlayercfg = import(".public.LocalPlayer") -- 本地数据

laixia.utilscfg = import(".tools.init")
laixia.UItools = import(".tools.UITools")     --公共的工具方法


laixia.Layout = import(".tools.Layout")     --调取csb工具方法

laixia.soundTools = import(".tools.SoundTools") --声音工具
...
laixia.logGame =     logGame      --laixia.logGame
...
laixia.Loader = import(".tools.IBaseLoader")


laixia.JsonTxtData = import(".data.init");
laixia.net = import(".net.init")
laixia.Queue = import(".net.Queue");
laixia.ui = import(".ui.Init")
laixia.ani = import(".animation.init")
