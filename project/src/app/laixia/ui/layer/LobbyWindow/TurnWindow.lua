...
--        self.Text_Award:setVisible(false)
        ...
        for key,value in pairs(self.dataInfo.TurnTableRewards) do
            if value ~= nil then
                ...
                elseif (item~=nil and item.ItemType == 3 ) then
                     ...
                     userdefault:setStringForKey(("FirstPrice_" .. key),laixia.helper.numeralRules_2( value.Num)..item.ItemName)
                end
            else
        ...
        --         userdefault:setStringForKey(("FirstName_3"),laixia.LocalPlayercfg.TurnWindow_NickName)
        --     end
        ...
        --          userdefault:setStringForKey(("FirstPrice_3"),laixia.LocalPlayercfg.TurnWindow_Award)
        --      end 
        --  else
