...
function TPReconnect:onInit()
    ...
    ObjectEventDispatch:addEventListener(_LAIXIA_EVENT_SHOW_MARKEDJUMP_WINDOW, handler(self, self.show))
    ObjectEventDispatch:addEventListener(_LAIXIA_EVENT_HIDE_MARKEDJUMP_WINDOW, handler(self, self.onDestroys))
end
