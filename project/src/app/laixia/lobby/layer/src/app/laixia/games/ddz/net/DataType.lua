...
TypeArray.MatchRoom =
    {
        { "RoomType", CDataTypeObj.Byte },  -- match_type                   房间类型1人满开始0定时开赛   
        { "Sate", CDataTypeObj.Byte },      -- enroll_status                当前状态，1报名前，2报名中，3报名结束
        { "SelfJoin", CDataTypeObj.Byte },  -- 自己是否报名比赛 1，是0 否   *↑字段中
        { "RoomID", CDataTypeObj.Int },     -- match_id                     房间ID
        { "CurJoinNum", CDataTypeObj.Int }, -- 当前报名人数                 *服务器补充字段
        { "JoinMinLimit",CDataTypeObj.Int}, -- begin_min                    最少开赛人数限制
        { "Time", CDataTypeObj.Int },       -- match_start_timestamp        比赛开始时间戳
        { "RoomName", CDataTypeObj.UTF8 },  -- match_name                   房间名称
        { "Icon",CDataTypeObj.UTF8},        -- icon                         图标
        { "BaomingInfo",CDataTypeObj.UTF8}, -- champion_award               报名信息冠军奖励
        {"BeginTime",CDataTypeObj.UTF8},    -- match_start_timestamp        比赛开始时间戳
        {"EndTime",CDataTypeObj.UTF8},      -- match_end_timestamp          比赛结束时间戳
        {"Baomingfei",CDataTypeObj.UTF8},   -- enter_fee                    报名费
        {"JoinTimes",CDataTypeObj.Int},     -- enroll_start_timestamp       报名开始时间戳
        {"isTop",CDataTypeObj.Int},         -- 服务给的顺序自己报名item上提
        -- begin_max             -- 最大开赛人数
        -- award_desc            -- 奖励介绍
        -- rules_desc            -- 赛制介绍
        -- enroll_end_timestamp  -- 报名结束时间戳
        -- enter_condition       -- 报名条件
        -- match_desc            -- 比赛介绍
        -- tabs                  -- 页签列表
    }
