...
function TPBind_Complete:onInit()
    ...
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_SHOW_BINDTRUE_WINDOW, handler(self, self.show))
end
...
function TPBind_Complete:onShow()
    ...
    self:GetWidgetByName("BindComplete_Label_PhoneNumber"):setString("手机号码："..laixiaddz.LocalPlayercfg.LaixiaPhoneNum)
    self:GetWidgetByName("BindComplete_Label_PassWorld"):setString("密码："..laixiaddz.LocalPlayercfg.LaixiaPassword)
