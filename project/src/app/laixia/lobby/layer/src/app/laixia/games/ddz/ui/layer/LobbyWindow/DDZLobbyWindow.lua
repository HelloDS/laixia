...
--local CSBBase = require("app.laixia.games.ddz.ui.CSBBase")
...
function DDZLobbyWindow:onTabButtonClicked(sender , event)
    ...
    if senderName == "btn_game" then
        ...
        local stream = Packet.new("EnterListRoom", _laixiaddz_PACKET_CS_ListRoomID)
    ...
    elseif senderName == "btn_match" then
        ...
        local CSMatchListPacket = Packet.new("CSMatchGame", _laixiaddz_PACKET_CS_MatchGameID)
