...
function LobbyBottomWindow:onInit()
    ...
    ObjectEventDispatch:addEventListener(_LAIXIA_EVENT_SHOW_COMMONFLOOR_WINDOW, handler(self, self.show))
    ObjectEventDispatch:addEventListener(_LAIXIA_EVENT_SEND_QUICKGAME_WINDOW, handler(self, self.sendQuickGame)) 
end
