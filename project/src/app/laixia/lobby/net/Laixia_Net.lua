...
function Net:start()
    ...
    -- if laixia.kconfig.isTest == true then 
    --     if laixia.kconfig.isYingKe == true then
    --         newGamePlatformID = 9
    --     else
    --         newGamePlatformID = 5
    --     end
    --     newAccount = "o2uiN0lV1Z0RtA2kqnedXLidJI6g"
    --     newToken = "7_BHbGYCQKN6jEQ7rcGRxAq3EB9zfHNNIeUxwkrVyxK7IDlo7ToEcBfu00-LJ3RSMSjC4jXfaogTdn6NBPuShrytKIHYXp2hseqwg8hIwgkFI"
    --     newChannelID = "201009"
    --     newUnionID = "o2uiN0jwpYYYSThRm5nZoGG436mk"
    -- end
