...
AgentManager.getIAPPlugin = AgentManager.getYAPPlugin

ProtocolIAP = ProtocolYAP
ProtocolIAP.resetPayState = ProtocolYAP.resetYapState
ProtocolIAP.payForProduct = ProtocolYAP.yapForProduct
ProtocolAdTracking.onPay = ProtocolAdTracking.onYap
