...
function StatusCode:ctor(aiStatus,info)
	...
	local function  handleError()
		...
		elseif aiStatus == 2 then
			ObjectEventDispatch:pushEvent(_LAIXIA_EVENT_SHOW_MARKEDWORDS_WINDOW, "请稍后！")
		...
		elseif aiStatus == 108 then
			ObjectEventDispatch:pushEvent(_LAIXIA_EVENT_SHOW_MARKEDWORDS_WINDOW,"实名认证成功！获得10000金币")
		end
	end
