...
function CounselWindow:onInit()
	...
	ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_SHOW_COUNSEL_WINDOW, handler(self, self.show))
end
...
function CounselWindow:showloading()
	ObjectEventDispatch:pushEvent(_laixiaddz_EVENT_SHOW_LOADIN_WINDOW)
end
