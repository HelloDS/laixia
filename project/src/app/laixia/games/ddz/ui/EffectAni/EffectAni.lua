...
function EffectAni:deskSpring(aiAdder)
    laixiaddz.soundTools.playSound(soundConfig.EVENT_SOUND.ui_event_spring)
    local system = laixiaddz.ani.CObjectAnimationManager;

    dump("system--EffectAni")
    ...
    local funAction2 = cc.CallFunc:create(function()
        ...
        aiAdder = nil
        ObjectEventDispatch:pushEvent(_laixiaddz_EVENT_SPRING_LANDLORDTABLE_WINDOW,"springOver")
...
function EffectAni:deskAlarm(aiAdder)
    laixiaddz.soundTools.playSound(soundConfig.EVENT_SOUND.ui_event_warning)
    local system = laixiaddz.ani.CObjectAnimationManager;
    local node = system:playAnimationAt(aiAdder,"hongdeng","Default Timeline",
        function ()
            laixiaddz.loggame("PlayAnimation End ")
        end )
end
    ...
    aiAdder:runAction(cc.Sequence:create(
                    ...
                    cc.CallFunc:create(
                        function()                                                        
                            ...
                            self.lostloopAni:setLocalZOrder(1005)
    ...
    aiAdder:runAction(cc.Sequence:create(
                    ...
                    cc.CallFunc:create(
                        function()                                                        
                            ...
                            self.victoryloopAni:setLocalZOrder(1005)
...
function EffectAni:deskOpenPoker(aiAdder)
    ...
    laixiaddz.soundTools.playSound(soundConfig.EVENT_SOUND.ui_evevt_open_hand)
