...
function LobbyTopWindow:onInit()
    ...
    ObjectEventDispatch:addEventListener("lobby_top_win_update_coin", handler(self, self.loadData))
end
...
-----------------------------------------------------------------------------------------------------
        self.Room_Title_Points_Text = self:GetWidgetByName("Room_Title_Points_Text")
        self.Room_Title_Points_Text1 = self:GetWidgetByName("Room_Title_Points_Text1")
        self.Text_zhishibi = self:GetWidgetByName("Text_zhishibi")
        -- self:setAdaptation()
        self.Panel_top = self:GetWidgetByName("Panel_1")
        self.Room_Title_Points_Text:setString(laixiaddz.helper.numeralRules_5(laixiaddz.LocalPlayercfg.LaixiaGoldCoin))
        self.Text_zhishibi:setString(laixiaddz.LocalPlayercfg.LaixiaZsCoin)
        self.Room_Title_Points_Text1:setString(laixiaddz.LocalPlayercfg.LaixiaLdCoin)
...
function LobbyTopWindow:loadData()
    if self.mIsShow then
        local Room_Title_Points_Text = self:GetWidgetByName("Room_Title_Points_Text")
        if Room_Title_Points_Text then
            Room_Title_Points_Text:setString(laixiaddz.helper.numeralRules_5(laixiaddz.LocalPlayercfg.LaixiaGoldCoin))
        end
        local Room_Title_Points_Text1 = self:GetWidgetByName("Room_Title_Points_Text1")
        if Room_Title_Points_Text1 then
            self:GetWidgetByName("Room_Title_Points_Text1"):setString(laixiaddz.LocalPlayercfg.LaixiaLdCoin)  
        end  
        if laixiaddz.kconfig.isYingKe==true then  
            local Text_zhishibi = self:GetWidgetByName("Text_zhishibi")
            if Text_zhishibi then
                self:GetWidgetByName("Text_zhishibi"):setString(laixiaddz.LocalPlayercfg.LaixiaZsCoin)
            end  
        end
    end
