...
function Activity:onShow(data)
    if laixiaddz.kconfig.isYingKe == true or laixiaddz.LocalPlayercfg.isShouchong == false then
...
function Activity:onDestroy()
    ...
    if laixiaddz.LocalPlayercfg.isShouchong == true and laixiaddz.LocalPlayercfg.LaixiaIsSign == 1 and laixiaddz.kconfig.isYingKe == false then
