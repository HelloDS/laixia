...
function TiShiyu:onInit()
    ...
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_SHOW_MARKEDWORDS_WINDOW, handler(self, self.show))
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_HIDE_MARKEDWORDS_WINDOW, handler(self, self.destroy))
end
