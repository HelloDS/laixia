...
local Animation = class("Animation", function()
    return ccs.GUIReader:getInstance():widgetFromBinaryFile("games/ddz/new_ui/Animation.csb")
end )
...
function Animation:ctor(...)
    ...
    ObjectEventDispatch:addEventListener(_laixiaddz_EVENT_SHOW_EFFECTGOLD_WINDOW, handler(self, self.jinbitexiao)) --显示金币掉落
...
function Animation:jinbitexiao(data)
    laixiaddz.soundTools.playSound(soundConfig.EVENT_SOUND.ui_evevt_achieve_gold)
